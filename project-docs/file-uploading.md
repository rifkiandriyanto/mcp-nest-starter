...
Out-of-box boilerplate supports the following drivers: `local`, `s3`, and `s3-presigned`. You can set it in the `.env` file, variable `ASSET_DRIVER`. If you want to use another service for storing files, you can extend it.
